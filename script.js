...
document.addEventListener('DOMContentLoaded', function() {
    const animateElements = document.querySelectorAll('.education-item, .experience-card, .project-card, .achievement-card, .activity-card, .skill-category');
...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        // Create mailto link
        const mailtoLink = `mailto:kattamanojkumar2005@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
    ...
    const achievementObserver = new IntersectionObserver(function(entries) {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                // Example: animateCounter(someElement, 600); for LeetCode problems
            }
        });
    }, { threshold: 0.5 });
